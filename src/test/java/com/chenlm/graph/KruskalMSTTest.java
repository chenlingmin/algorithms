...
public class KruskalMSTTest {
    ...
    public void test() {
        ...
        String filename1 = "testGW1.txt";
        int V1 = 8;

        String filename2 = "testGW2.txt";
        int V2 = 250;

        String filename3 = "testGW3.txt";
        int V3 = 1000;

        String filename4 = "testGW4.txt";
        int V4 = 10000;
...
//        System.out.println( filename5 + " load successfully.");
        ...
        // Test Lazy Prim MST
        System.out.println("Test Lazy Kruskal MST:");
...
//        startTime = System.currentTimeMillis();
//        KruskalMST<Double> lazyPrimMST5 = new KruskalMST<Double>(g5);
//        endTime = System.currentTimeMillis();
